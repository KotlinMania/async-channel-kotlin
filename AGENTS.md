...
This file is the quick-reference operating contract for async-channel-kotlin. The longer
...
async-channel-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`async-channel`](https://crates.io/crates/async-channel). Upstream Rust is the behavioral oracle while the
