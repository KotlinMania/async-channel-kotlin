...
kotlin {
    ...
    val xcf = XCFramework("AsyncChannel")

    macosArm64 {
        binaries.framework { baseName = "AsyncChannel"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "AsyncChannel"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "AsyncChannel"
        flattenPackage = "io.github.kotlinmania.asyncchannel"
    }

    android {
        namespace = "io.github.kotlinmania.asyncchannel"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "async-channel-kotlin", version.toString())

    pom {
        name.set("async-channel-kotlin")
        description.set("Kotlin Multiplatform port of smol-rs/async-channel - Async multi-producer multi-consumer channel")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/async-channel-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/async-channel-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/async-channel-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/async-channel-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleDebugIosFatFrameworkForAsyncChannelXCFramework",
    "assembleReleaseIosFatFrameworkForAsyncChannelXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAsyncChannelXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAsyncChannelXCFramework",
    "assembleDebugMacosFatFrameworkForAsyncChannelXCFramework",
    "assembleReleaseMacosFatFrameworkForAsyncChannelXCFramework",
    "assembleDebugTvosFatFrameworkForAsyncChannelXCFramework",
    "assembleReleaseTvosFatFrameworkForAsyncChannelXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAsyncChannelXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAsyncChannelXCFramework",
    "assembleDebugWatchosFatFrameworkForAsyncChannelXCFramework",
    "assembleReleaseWatchosFatFrameworkForAsyncChannelXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAsyncChannelXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAsyncChannelXCFramework",
